...
const imgPath = '/static/images/animales/';
...
function handleBackgroundImage() {
    ...
    if (screen.width <= minWidth) {
        imgDeFondo.setAttribute('src', '/static/images/papel-tapiz/hojas-verdes-celulares.jpg');
    }
}
...
function imgAnimalClickHandler(e) {
    ...
    window.location = "/static/links/animales/animales.html";
}
...
function pDespListClickHandler(e) {
    ...
    //Cambio de página a "animals-explanation"
    window.location = "/static/links/pilares/pilares.html";
}
